...
public class MusicPlayingView extends View {
    ...
    public MusicPlayingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.MusicPlayView);
        mPaint.setColor(array.getColor(R.styleable.MusicPlayView_line_color,
                ContextCompat.getColor(context, android.R.color.black)));
        during = array.getInteger(R.styleable.MusicPlayView_refresh_duration, 180);
